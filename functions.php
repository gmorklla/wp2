...
function wpc_theme_js() {
	...
	wp_enqueue_script( 'foundation_js', get_template_directory_uri() . '/js/foundation.js', array('jquery'), '', true ); // true or false for putting on footer or header of our site
